...
public class RozvrhBETA
implements ItemListener {
    String[] items = new String[]{" ", "Java", "Kreslen\u0102\u00ad", "Tvorba", "Psan\u0102\u00ad", "U\u00c4\u0164en\u0102\u00ad", "\u0102\u0161klid", "Kytara", "BezInternetu", "HTML", "Proch\u0102\u02c7zka", "Kamar\u0102\u02c7di", "Hygiena", "Ang", "Fr", "Dom\u0102\u02c7c\u0102\u00adPr\u0102\u02c7ce", "Cvi\u00c4\u0164en\u0102\u00ad", "Spln\u00c4\u203an\u0102\u00ad\u0102\u015fkol\u0139\u017b", "BrzoVst\u0102\u02c7t", "NJ"};
    ...
    static Choice ch5;
    static Choice ch6;
    JButton b1 = new JButton("Sou\u00c4\u0164et");
    JButton b2;
    ...
    public void itemStateChanged(ItemEvent itemEvent) {
        if (ch1.getSelectedItem() != null) {
            l2.setText(points[ch1.getSelectedIndex()] + " b.");
        }
        if (ch2.getSelectedItem() != null) {
            l3.setText(points[ch2.getSelectedIndex()] + " b.");
        }
        if (ch3.getSelectedItem() != null) {
            l4.setText(points[ch3.getSelectedIndex()] + " b.");
        }
        if (ch4.getSelectedItem() != null) {
            l5.setText(points[ch4.getSelectedIndex()] + " b.");
        }
        if (ch5.getSelectedItem() != null) {
            l6.setText(points[ch5.getSelectedIndex()] + " b.");
        }
        if (ch6.getSelectedItem() != null) {
            l7.setText(points[ch6.getSelectedIndex()] + " b.");
        }
    }
    ...
    implements ActionListener {
        ...
        @Override
        public void actionPerformed(ActionEvent actionEvent) {
            sou.setText(points[ch1.getSelectedIndex()] + points[ch2.getSelectedIndex()] + points[ch3.getSelectedIndex()] + points[ch4.getSelectedIndex()] + points[ch5.getSelectedIndex()] + points[ch6.getSelectedIndex()] + " bod\u0139\u017b");
        }
    }
}
